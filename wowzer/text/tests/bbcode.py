...
from zilbo.common.text import bbcode
from zilbo.common.text.utils import get_member_link   
...
tests = (
    ...
    ('[url]/foo/?a=1&b=2[/url]',
        '<div><a rel="nofollow" href="/foo/?a=1&amp;b=2">/foo/?a=1&amp;b=2</a></div>'),
    ('[url=/foo/?a=1&b=2]bar[/url]',
        '<div><a rel="nofollow" href="/foo/?a=1&amp;b=2">bar</a></div>'),
    # empty url
    ('[url][/url]',
        '<div></div>'),
    ('[member]Joey[/member]',
